  ...
  <div class="min-h-screen bg-gradient-to-b from-green-100 to-green-50 py-16 px-6 sm:px-12 lg:px-20">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <!-- Card 1 -->
        <div
          class="bg-gradient-to-tr from-green-200 via-green-300 to-green-400 rounded-3xl shadow-lg p-8 flex flex-col items-center text-center transition-transform hover:scale-105"
        >
          <div class="bg-white rounded-full p-6 mb-6 shadow-inner">
            ...
            >
              <path
                ...
                d="M9 12h6m-6 4h6m2 0a2 2 0 100-4 2 2 0 000 4zm-6-8h.01M3 6h18M4 10h16M4 14h16"
              />
            </svg>
          </div>
          <h3 class="text-2xl font-extrabold text-green-900 mb-2 drop-shadow-sm">
        ...
        <!-- Card 2 -->
        <div
          class="bg-gradient-to-tr from-green-300 via-green-400 to-green-500 rounded-3xl shadow-lg p-8 flex flex-col items-center text-center transition-transform hover:scale-105"
        >
          <div class="bg-white rounded-full p-6 mb-6 shadow-inner">
            <svg
              class="h-16 w-16 text-green-800"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
          ...
          <div class="bg-white rounded-full p-6 mb-6 shadow-inner">
            ...
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
                d="M9 17l-2-2m0 0l2-2m-2 2h6m4 0a9 9 0 11-18 0 9 9 0 0118 0z"
              />
            </svg>
          </div>
          <h3 class="text-2xl font-extrabold text-green-900 mb-2 drop-shadow-sm">
